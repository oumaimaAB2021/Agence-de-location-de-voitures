...
<head>
    <title>Index</title>
    <link rel="stylesheet" type="text/css" href="css/acceuilAdmin.css" />
            ...
            <div id="auto">
                ...
                <div class="card-list">
                    ...
                    <div class="card-one">
                        ...
                        <a href="modifier.php?car=<?php echo$ligne['Matricule'] ?>"> <img src="<?php echo $ligne['Photo'] ?>" /> </a> <br />
    ...
    <div class="pagination">
                    ...
                    /**afficher les pages */
                            for($page=1;$page<=$num_page;$page++){
                                echo '<a href=acceuilAdmin.php?page='.$page.'>'.$page.'</a>';
                            }
                            ?>
                         </div>
